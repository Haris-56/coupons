            ...
            <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-8 max-w-4xl">
                <form action={formAction} className="space-y-6">
                    ...
                    <div className="space-y-1">
                        ...
                        <input name="name" defaultValue={user.name} required type="text" className="w-full px-4 py-2.5 border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-blue-500 transition-all" />
                    </div>

                    {/* Email */}
                    <div className="space-y-1">
                        <label className="text-xs font-bold text-slate-500 uppercase">Email</label>
                        <input name="email" defaultValue={user.email} required type="email" className="w-full px-4 py-2.5 border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-blue-500 transition-all" />
                    </div>
                    ...
                    <div className="space-y-1">
                        ...
                        <select name="role" defaultValue={user.role} className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-lg text-sm text-slate-700 focus:outline-none focus:border-blue-500 transition-all">
